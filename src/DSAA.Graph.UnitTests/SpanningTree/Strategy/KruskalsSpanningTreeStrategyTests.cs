...
{
    public sealed class KruskalsSpanningTreeStrategyTests
    {
                ...
                new object[]
                {
                    Graphs.K5, new[]
                    {
                        new []
                        {
                            ...
                            new EdgeDescriptor<int>(1, (3, 13), (4, 13))
                        }
                    }
                },
                new object[]
        ...
        public static IEnumerable<object[]> NoSpanningTreeTests =>
            new List<object[]>
            {
                new object[]
                {
                    Graphs.Rail_0_Disconnected
                },
                new object[]
                {
                    Graphs.Rail_5_Disconnected
                },
            };
            ...
            EdgeDescriptor<int>[][] expectedEdgeCollections)
        {
            ...
            // Act
            var result = Sut.FindSpanningTree(o => o.UseKruskals())
                .Single()
                .OrderBy(e => e.Source)
        ...
        public void Given_Graph_When_GraphIsForest_Then_ReturnTreePerDisconnectedGraph(EdgeDescriptor<int>[] edges,
            EdgeDescriptor<int>[][] expectedEdgeCollections)
        {
            // Arrange
            Sut.AddToGraph(edges);
        ...
        [Theory]
        [MemberData(nameof(NoSpanningTreeTests))]
        public void Given_Graph_When_NoMinimumSpanningTreePossible_Then_Throw(EdgeDescriptor<int>[] edges)
        {
            // Arrange
            Sut.AddToGraph(edges);
            ...
            // Act
            // Assert
            Assert.Throws<GraphException<int>>(() => Sut.FindSpanningTree(o => o.UseKruskals()));
        }
    }
}